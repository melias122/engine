...
func TestFilterSmernica(t *testing.T) {
	tests := []struct {
		...
		{Kombinacia{14, 16, 26, 27}, NewFilterSmernica(5, 35, 0.0, 1.0), true},         // 0.499...
		{Kombinacia{14, 16, 26, 27, 30}, NewFilterSmernica(5, 35, 0.0, 1.0), true},     // 0.499...
		{Kombinacia{14, 16, 26, 27, 30}, NewFilterSmernica(5, 35, 0.0, 0.49), true},    // 0.499...
		{Kombinacia{14, 16, 26, 27, 30}, NewFilterSmernica(5, 35, 0.49, 0.5), true},    // 0.499...
		{Kombinacia{14, 16, 26, 27, 30}, NewFilterSmernica(5, 35, 0.499, 0.499), true}, // 0.499...
		{Kombinacia{14, 16, 26, 27, 30}, NewFilterSmernica(5, 35, 0.5, 0.5), true},
		{Kombinacia{14, 16, 26, 27, 30}, NewFilterSmernica(5, 35, 0.500000001, 0.6), false}, // 0.499...
	}
	for _, test := range tests {
