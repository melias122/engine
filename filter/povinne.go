...
func PovinneFromString(s string, last komb.Kombinacia, n, m int) (Filter, error) {
...
func (p povinne) CheckSkupina(s hrx.Skupina) bool {
	return true
}
...
func PovinneSTLFromString(s string, zhoda []byte, n, m int) (Filter, error) {
	parser := parser.NewParser(strings.NewReader(s), n, m)
	parser.Zhoda = zhoda
...
func (p povinneStl) CheckSkupina(s hrx.Skupina) bool {
	return true
}
