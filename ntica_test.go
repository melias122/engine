...
func TestFilterNtica(t *testing.T) {
	tests := []struct {
		...
		{Kombinacia{1, 2, 3, 4, 5}, NewFilterNtica(5, Tica{0, 0, 0, 0, 1}), true},
		{Kombinacia{1, 2, 3, 4, 6}, NewFilterNtica(5, Tica{1, 0, 0, 1, 0}), true},
		{Kombinacia{1, 2, 3, 5, 6}, NewFilterNtica(5, Tica{0, 1, 1, 0, 0}), true},
		{Kombinacia{1, 2, 3, 5, 7}, NewFilterNtica(5, Tica{2, 0, 1, 0, 0}), true},
		{Kombinacia{1, 2, 4, 5, 7}, NewFilterNtica(5, Tica{1, 2, 0, 0, 0}), true},
		{Kombinacia{1, 2, 4, 6, 8}, NewFilterNtica(5, Tica{3, 1, 0, 0, 0}), true},
		{Kombinacia{1, 3, 5, 7, 9}, NewFilterNtica(5, Tica{5, 0, 0, 0, 0}), true},

		{Kombinacia{1, 2, 3, 4, 5}, NewFilterNtica(5, Tica{5, 0, 0, 0, 0}), false},
	}
	for _, test := range tests {
...
func TestStlNtica(t *testing.T) {
	tests := []struct {
		...
		{NewFilterSTLNtica(4, Tica{4, 0, 0, 0}, []byte{0, 0, 0, 0}), Kombinacia{1, 3, 5, 7}},
		{NewFilterSTLNtica(4, Tica{2, 1, 0, 0}, []byte{1, 1, 0, 0}), Kombinacia{1, 2, 5, 7}},
		{NewFilterSTLNtica(4, Tica{2, 1, 0, 0}, []byte{0, 1, 1, 0}), Kombinacia{1, 3, 4, 7}},
		{NewFilterSTLNtica(4, Tica{2, 1, 0, 0}, []byte{0, 0, 1, 1}), Kombinacia{1, 3, 6, 7}},
		{NewFilterSTLNtica(4, Tica{1, 0, 1, 0}, []byte{1, 1, 1, 0}), Kombinacia{1, 2, 3, 7}},
		{NewFilterSTLNtica(4, Tica{1, 0, 1, 0}, []byte{0, 1, 1, 1}), Kombinacia{1, 3, 4, 5}},
		{NewFilterSTLNtica(4, Tica{0, 0, 0, 1}, []byte{1, 1, 1, 1}), Kombinacia{2, 3, 4, 5}},
		{
			Filter: NewFilterSTLNtica(5, Tica{0, 0, 0, 0, 1}, []byte{1, 1, 1, 1, 1}),
			k:      Kombinacia{1, 2, 3, 4, 5},
		},
		{
			Filter: NewFilterSTLNtica(6, Tica{4, 1, 0, 0, 0, 0}, []byte{0, 0, 0, 0, 1, 1}),
